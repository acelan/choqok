...
#ifndef PLURKAPISEARCH_H
#define PLURKAPISEARCH_H
...
*/
class CHOQOK_HELPER_EXPORT PlurkApiSearch : public QObject
{
    Q_OBJECT
public:
    PlurkApiSearch(QObject* parent = 0);
    virtual ~PlurkApiSearch();
