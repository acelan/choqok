...
class PlurkApiComposerWidget::Private
{
public:
    Private()
    :model(0)
...
PlurkApiComposerWidget::PlurkApiComposerWidget(Choqok::Account* account, QWidget* parent)
...
PlurkApiComposerWidget::~PlurkApiComposerWidget()
{
    delete d;
}

void PlurkApiComposerWidget::slotNewPostReady(Choqok::UI::PostWidget* widget, Choqok::Account* theAccount)
{
...
#include "plurkapicomposerwidget.moc"
