...
#ifndef PLURKAPIACCOUNT_H
#define PLURKAPIACCOUNT_H
...
*/
class CHOQOK_HELPER_EXPORT PlurkApiAccount : public Choqok::Account
{
    Q_OBJECT
public:
    PlurkApiAccount(PlurkApiMicroBlog* parent, const QString& alias);
    ~PlurkApiAccount();
