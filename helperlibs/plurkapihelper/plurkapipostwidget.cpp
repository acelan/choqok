...
const KIcon PlurkApiPostWidget::unFavIcon(Choqok::MediaManager::convertToGrayScale(KIcon("rating").pixmap(16)) );

class PlurkApiPostWidget::Private
{
public:
...
PlurkApiPostWidget::PlurkApiPostWidget(Choqok::Account* account, const Choqok::Post &post, QWidget* parent)
...
PlurkApiPostWidget::~PlurkApiPostWidget()
{
    delete d;
}

void PlurkApiPostWidget::initUi()
{
...
QString PlurkApiPostWidget::prepareStatus(const QString& text)
{
    return Choqok::UI::PostWidget::prepareStatus(text);
}

QString PlurkApiPostWidget::generateSign()
{
    QString sign;
...
void PlurkApiPostWidget::slotReply()
{
    setReadWithSignal();
    if(currentPost().isPrivate){
...
void PlurkApiPostWidget::slotSetFavorite(Choqok::Account *theAccount, const QString& postId)
{
...
void PlurkApiPostWidget::updateFavStat()
{
    if(currentPost().isFavorited){
...
void PlurkApiPostWidget::checkAnchor(const QUrl & url)
{
...
void PlurkApiPostWidget::slotBasePostFetched(Choqok::Account* theAccount, Choqok::Post* post)
{
...
void PlurkApiPostWidget::repeatPost()
{
    setReadWithSignal();
    ChoqokId postId;
...
#include "plurkapipostwidget.moc"
