...
class PlurkApiShowThread::Private{
public:
...
PlurkApiShowThread::PlurkApiShowThread(Choqok::Account* account, const Choqok::Post& finalPost,
                                           QWidget* parent)
...
PlurkApiShowThread::~PlurkApiShowThread()
{
    delete d;
}

void PlurkApiShowThread::setupUi()
{
    kDebug();
...
void PlurkApiShowThread::slotAddNewPost(Choqok::Account* theAccount, Choqok::Post* post)
{
    kDebug();
...
void PlurkApiShowThread::addPostWidgetToUi(Choqok::UI::PostWidget* widget)
{
    kDebug();
    widget->initUi();
    widget->setRead();
...
void PlurkApiShowThread::raiseMainWindow()
{
    Choqok::UI::Global::mainWindow()->activateWindow();
}

#include "plurkapishowthread.moc"
