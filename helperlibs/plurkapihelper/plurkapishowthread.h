...
#ifndef PLURKAPISHOWTHREAD_H
#define PLURKAPISHOWTHREAD_H
...
class CHOQOK_HELPER_EXPORT PlurkApiShowThread : public QWidget
{
    Q_OBJECT
public:
    PlurkApiShowThread( Choqok::Account *account, const Choqok::Post &finalPost, QWidget* parent = 0);
    ~PlurkApiShowThread();
