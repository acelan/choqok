...
PlurkApiTimelineWidget::PlurkApiTimelineWidget(Choqok::Account* account, const QString& timelineName,
                                                   QWidget* parent)
    : TimelineWidget(account, timelineName, parent)
{
    if(timelineName == "Favorite"){
        PlurkApiMicroBlog* mBlog = qobject_cast<PlurkApiMicroBlog*>(account->microblog());
        connect( mBlog, SIGNAL(favoriteRemoved(Choqok::Account*,QString)),
                 this, SLOT(removeUnFavoritedPost(Choqok::Account*,QString)) );
    }
}

PlurkApiTimelineWidget::~PlurkApiTimelineWidget()
{

}

void PlurkApiTimelineWidget::removeUnFavoritedPost(Choqok::Account* theAccount, const QString& postId)
{
