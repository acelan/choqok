...
#ifndef PLURKAPIPOSTWIDGET_H
#define PLURKAPIPOSTWIDGET_H
...
*/
class CHOQOK_HELPER_EXPORT PlurkApiPostWidget : public Choqok::UI::PostWidget
{
    Q_OBJECT
public:
    PlurkApiPostWidget(Choqok::Account* account, const Choqok::Post &post, QWidget* parent = 0);
    ~PlurkApiPostWidget();
    virtual void initUi();
